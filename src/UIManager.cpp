...
#ifdef CL_VULKAN
        //TODO: Add Vulkan initialization
#else
...
#ifdef CL_VULKAN
            //TODO: still necessary in vulkan?
#else
...
#ifdef CL_VULKAN
        //TODO: Do Vulkan Rendering
#else
        ImGui_ImplOpenGL3_RenderDrawData(ImGui::GetDrawData());
#endif
    }

    void UIManager::AddWindow(Panel *window) {
        m_windows.push_back(window);
    }

    void UIManager::ShowDockSpace(bool *open) {
